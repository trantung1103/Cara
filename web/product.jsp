                    ...
                    <div class="col-md-6">
                        <div class="single-pro-img">
                            ...
                            <div class="small-img-group">
                                <div class="col-sm-3">
                                    <img src="./assets/img/products/g.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/products/g3.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/products/g5.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/products/g7.jpg" alt="" class="small-img" width="100%">
                                </div>
                            </div>
                        </div>
                    </div>
